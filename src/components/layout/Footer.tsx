...
const TICKER_ITEMS = [
  "36 HOURS", "✦", "NON-STOP CODING", "✦", "3000+ HACKERS", "✦", "FREE FOOD", "✦", "₹15L+ PRIZE POOL", "✦",
  "36 HOURS", "✦", "NON-STOP CODING", "✦", "3000+ HACKERS", "✦", "FREE FOOD", "✦", "₹15L+ PRIZE POOL", "✦",
  "36 HOURS", "✦", "NON-STOP CODING", "✦", "3000+ HACKERS", "✦", "FREE FOOD", "✦", "₹15L+ PRIZE POOL", "✦",
];

const TRACKS_TICKER_ITEMS = [
  "SPORTS - TECH", "✦", "CLOUD COMPUTING", "✦", "DISASTER MANAGEMENT", "✦", "ROAD SAFETY", "✦", "AGRICULTURE", "✦", "HEALTHCARE MANAGEMENT", "✦", "ENVIRONMENT MANAGEMENT", "✦", "BEST USE OF N8N", "✦", "OPEN INNOVATION", "✦",
  "SPORTS - TECH", "✦", "CLOUD COMPUTING", "✦", "DISASTER MANAGEMENT", "✦", "ROAD SAFETY", "✦", "AGRICULTURE", "✦", "HEALTHCARE MANAGEMENT", "✦", "ENVIRONMENT MANAGEMENT", "✦", "BEST USE OF N8N", "✦", "OPEN INNOVATION", "✦",
];
      ...
      <div className="max-w-7xl mx-auto px-6 pt-12 pb-[140px] md:pb-16 relative z-10">
        ...
        <div className="footer-grid grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            ...
            <div className="flex flex-col items-center md:flex-row md:items-center gap-2 md:gap-4">
              ...
              >
                <Image
                  ...
                  width={110}
                  height={38}
                  className="h-[24px] w-auto object-contain opacity-100 transition-opacity duration-300 brightness-110"
                />
              </a>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center md:items-start gap-3">
            ...
            <div className="flex flex-col gap-3 items-center md:items-start w-fit">
              <a href="mailto:hashtag.gn@jagannath.org" target="_blank" rel="noopener noreferrer" className="flex items-center md:items-start gap-2 font-nunito font-semibold text-cream/60 hover:text-gold transition-colors text-sm text-center md:text-left">
                <Mail className="w-4 h-4 shrink-0" />
                <span>hashtag.gn@jagannath.org</span>
              </a>
              <a href="https://www.google.com/maps/search/?api=1&query=48%2F4%2C+Knowledge+Park+III%2C+Greater+Noida%2C+Noida%2C+Uttar+Pradesh+201310" target="_blank" rel="noopener noreferrer" className="flex items-center md:items-start gap-2 font-nunito font-semibold text-cream/60 hover:text-gold transition-colors text-sm text-center md:text-left flex-col md:flex-row">
                <MapPin className="w-4 h-4 shrink-0" />
                <span>
                  48/4, Knowledge Park III, Greater Noida,<br className="hidden md:block" />
